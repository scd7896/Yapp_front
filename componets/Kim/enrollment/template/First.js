...
import {
  ...
  RMV_PORJECT_POSITION,
  ADD_PORJECT_POSITION,
  SET_PROJECT_NOWTEAM,
  SET_PROJECT_IMAGE
      ...
      <div className="enroll_container">
        ...
        <div className="enrollment_keyword_container">
              ...
              {keywords.map((el, i) => {
                return (
                  <Keyword
                    ...
                    index={i}
                    isSelected={
                      projectKeyword.findIndex(keyword => keyword === i) !== -1
                    }
                    key={i}
                  />
                );
          ...
          <div className="project_img">
            ...
            <form
              className={!projectImage.url ? "multerBox" : "background_none"}
              onClick={changeImage}
            >
              {projectImage.url ? (
                <div>
