...
export default (props) => {
    ...
    var thumbnail = (
        <div className = 'user-profile-thubnail' style = {{width:size, height:size}}>
            <svg style = {{'margin-left' : (62.7/178) * parseInt(size), 'margin-top' : (56/178) * parseInt(size)} } xmlns="http://www.w3.org/2000/svg" width={(58.768/178) * parseInt(size)} height={(66.813/178) * parseInt(size)} viewBox="0 0 58.768 66.813">
