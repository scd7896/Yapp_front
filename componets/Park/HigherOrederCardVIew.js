...
function HigherOrderCardViewSection(CardView, CardViewTypeStr){
    return class CardViewSectionWrapper extends React.Component{
        ...
        render(){
            ...
            return (
                <div  className = "CardView-Wrapper-Absolute">
                <div  className = "CardView-Wrapper">
                    <button className = {"CardView-Hover-" + (this.props.isMobile ? 'Mobile' :"PC") +  " CardView-Hover-Left"} 
                    ...
                    <button className = {"CardView-Hover-" + (this.props.isMobile ? 'Mobile' :"PC") +  " CardView-Hover-Right"}
