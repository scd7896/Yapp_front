...
const ProjectCardView = props => {
  ...
  if (props != undefined && props.project != undefined) {
    ...
    rolesComponent = rolesArr.map(role => (
      <ProjectJobGroup jobgroup={role} size="small" />
    ));
  }
  ...
  return (
    <div className="project-cardview">
      <Link
        href={props.project ? "/detail/[id]" : ""}
        as={props.project ? "/detail/" + props.project.projectId : ""}
      >
        <a>
          <img
            className="project-cardview-banner"
            src={
              props.project && props.project.thumbnailImage
                ? props.project.thumbnailImage
                : imgURLs[props.project ? props.project.projectId % 3 : 0]
            }
          ></img>
          <div className="project-cardview-contents">
            ...
            <div className="project-cardview-time">
              ...
              <div className="project-cardview-detail">
                <FavoriteButton project={props.project} />
              </div>
            </div>
          </div>
        </a>
