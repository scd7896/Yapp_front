      ...
      <div id="detail_root">
                  ...
                  <div className="detail-button-flex">
                    <div className="detail-favorite-button">
                      <svg
                        ...
                        width="17.854"
                        height="25.768"
                        viewBox="0 0 17.854 25.768"
                      >
                        <g
                          id="그룹_1901"
                          data-name="그룹 1901"
                          transform="translate(-1450.769 -61)"
                        >
                          <path
                            id="패스_1756"
                            data-name="패스 1756"
                            d="M1477.957,92.98v12.79h-.166l-8.582-6.594Z"
                            transform="translate(-9.334 -19.003)"
                            fill="#afafaf"
                          />
                          <path
                            id="패스_1757"
                            data-name="패스 1757"
                            d="M1464.623,61V73.977l-8.749,6.2-9.106,6.452V61Z"
        ...
        <div className="detail-contents-container container">
          ...
          <div className="detail-introduce-contents">
            모임장소 정할 때 중간지점 찾아주는 모바일 앱 서비스입니다. 서비스
            기능 정의는 다 되어 있습니다!
            <br />
            현재 iOS 개발자와, 안드로이드 개발자 팀원이 있으며 서비스 디자인
            해주실 디자이너 분이 필요한 상황입니다.
            <br />
          </div>
        </div>
